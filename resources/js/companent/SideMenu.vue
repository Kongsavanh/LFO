...
<ul class="menu-inner py-1">
  ...
  <!-- Dashboards -->
  <li class="menu-item">
    <router-link to="/PR"  class="menu-link ">
      <i class='bx bx-purchase-tag-alt menu-icon'></i>
      <div data-i18n="Dashboards">Procurement Request</div>
    </router-link>
  </li>

  <li class="menu-item">
    <router-link to="/PO"  class="menu-link ">
      <i class='bx bxs-purchase-tag menu-icon'></i>
      <div data-i18n="Dashboards">Procurement Order</div>
    </router-link>
  </li>

  <li class="menu-item">
    <router-link to="/inventory"  class="menu-link ">
      <i class='bx bxs-cylinder menu-icon'></i>

    
      <div data-i18n="Dashboards">Inventory</div>
    </router-link>
  </li>
  <li class="menu-item">
